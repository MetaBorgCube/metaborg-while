...
public class WhilelangParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("Whilelang");
  ...
  { 
    WhilelangParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = WhilelangParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = WhilelangParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(WhilelangParseControllerGenerated.class);
    }
  ...
  { 
    return WhilelangParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
